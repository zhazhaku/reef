...
Examples:
  reef model                    # Show current default model
  reef model gpt-5.2           # Set gpt-5.2 as default
  reef model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  reef model local-model       # Set local VLLM server as default
