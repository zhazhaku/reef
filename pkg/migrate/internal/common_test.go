...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.reef")
	assert.Equal(t, "/home/user/.reef/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.reef/workspace/file.txt", "/home/user/.reef")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".reef"), result)
}
