...
func TestLoadOpenClawConfig(t *testing.T) {
	...
	if workspace != "~/.reef/workspace" {
		t.Errorf("expected workspace '~/.reef/workspace', got '%s'", workspace)
	}
...
func TestConvertToPicoClaw(t *testing.T) {
	...
	if picoCfg.Agents.Defaults.Workspace != "~/.reef/workspace" {
		t.Errorf("expected workspace '~/.reef/workspace', got '%s'", picoCfg.Agents.Defaults.Workspace)
	}
...
func TestToStandardConfig(t *testing.T) {
	...
	if stdCfg.Agents.Defaults.Workspace != "~/.reef/workspace" {
		t.Errorf("expected workspace '~/.reef/workspace', got '%s'", stdCfg.Agents.Defaults.Workspace)
	}
